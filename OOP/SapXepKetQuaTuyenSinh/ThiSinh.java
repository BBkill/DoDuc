class ThiSinh implements Comparable<ThiSinh> {
    ...
    {
        StringBuilder kq =new StringBuilder(String.valueOf(diem1*2+diem2+diem3+Double.parseDouble(diemUT())));
        int i= kq.indexOf(".");
    ...
    public int compareTo(ThiSinh o) {
        if(Float.parseFloat(tongDiem())-Float.parseFloat(o.tongDiem())>0) return -1;
        return 1;
    }
}